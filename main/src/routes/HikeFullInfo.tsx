          ...
          <div className='col px-3'>
            <Container className='rounded mt-2 mb-2 mx-0 pt-2 px-3' style={{  height:"37rem", padding:"0 12px 0 12px", backgroundColor:"#B4C3B1"}}>
              ...
              <div className='d-flex'>
                ...
                <Button onClick={handleShowInstructor} className='p-0 rounded mt-2' style={{backgroundColor:"#B6D3B0", color:"#ffffff", border:" 1px solid #89A889", textShadow:"1px 1px 0 #89A889, -1px -1px 0 #89A889, 1px -1px 0 #89A889, -1px 1px 0 #89A889, 1px 1px 0 #89A889", height:"38px", width:"30%", marginLeft:"9rem"}}>
                          <h6 className='m-0 p-0'>Сотстав</h6> 
                </Button>
              </div>
