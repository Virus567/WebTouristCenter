...
namespace TouristСenterLibrary
{
    public static class EntityConfigure
    {
        ...
        public static void RouteConfigure(EntityTypeBuilder<Route> builder)
        {
            ...
            routes.Add(new Route("Любимая Немда", 3, "Красавица река НЕМДА является жемчужиной Вятского края") { ID = 1, FullDescription= "Красавица река НЕМДА является жемчужиной Вятского края. Природа этих мест уникальна: выходы известняковых скал, рельефные берега, бурлящие перекаты, самый высокий водопад Кировской области, чистая родниковая вода, отсутствие комаров, живописные пейзажи", Popularity = 1, CheckpointStartID = 1, CheckpointFinishID = 2, River = "Nemda", Images =  new string[] { "1", "2", "3" } });
            routes.Add(new Route("Затерянный мир", 3, "Затерянный мир На Вятке") { ID = 2, FullDescription = "Затерянный мир На Вятке. Маршрут, где можно насладиться по настоящему дикой природой, редкими расстениями и ощутить настоящее единение с природой. ", Popularity = 1, CheckpointStartID = 3, CheckpointFinishID = 4, River = "Vyatka", Images = new string[] { "1", "2", "3" } });
            routes.Add(new Route("Родные просторы", 3, "Великолепный маршрут Родные просторы по берегам реки Вятки") { ID = 3, FullDescription = "Великолепный маршрут Родные просторы по берегам реки Вятки подарит огромное количество позитивных эмоций и незабываемых впечатлений.", Popularity = 1, CheckpointStartID = 5, CheckpointFinishID = 6, River = "Vyatka", Images = new string[] { "1", "2", "3" } });
            routes.Add(new Route("Поющие пески", 3, "Поющие пески Вятки ") { ID = 4, FullDescription = "У заброшенной деревни Атары в Кировской области, где Вятка делает крутой поворот, находится трехкилометровая отмель с белым песком из горного хрусталя и молочного кварца. ", Popularity = 1, CheckpointStartID = 7, CheckpointFinishID = 8, River = "Vyatka", Images = new string[] { "1", "2", "3" } });
            routes.Add(new Route("Быстрая вода", 2, "Очень красивые и живописные места, на очень быстрой и стремительной реке Быстрице") { ID = 5, FullDescription = "Очень красивые и живописные места, на очень быстрой и стремительной реке Быстрице откроются перед вами если вы посетите этот маршрут", Popularity = 1, CheckpointStartID = 9, CheckpointFinishID = 10, River = "Bystrica", Images = new string[] { "1", "2", "3" } });
            routes.Add(new Route("Город с воды", 1, "С воды раскрываются все красоты города Кирова") { ID = 6, FullDescription = "С воды раскрываются все красоты города Кирова. Появляется возможность насладиться ими прямо с водной глаяди реки Вятки.", Popularity = 1, CheckpointStartID = 11, CheckpointFinishID = 12, River = "Vyatka", Images = new string[] { "1", "2", "3" } });
        ...
        public static void InstructorConfigure(EntityTypeBuilder<Instructor> builder)
        {
            ...
            instructors.Add(new Instructor("Петрова", "Алиса", "Александровна", "3314 568475", "+79222106611", DateTime.Parse("7/8/2019 00:00")) { ID = 1, Login = "instr1", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Профессиональный повар. Могу приготовить на костре все что угодно от вкусной и наваристой ухи до блинов на завтрак.", Image = "" });
            instructors.Add(new Instructor("Зуева", "Екатерина", "Арсентьевна", "3315 264512", "+79536523958", DateTime.Parse("6/6/2020 00:00")) { ID = 2, Login = "instr2", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription= "Веселый Аниматор. Закончила цироковое училище, вожу в походы уже 7 лет.", Image = "" });
            instructors.Add(new Instructor("Степанов", "Артём", "Михайлович", "3316 895123", "+79122023227", DateTime.Parse("8/7/2021 00:00")) { ID = 3, Login = "instr3", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3",Discription = "Старший инструктор. Мастер в своем деле. С детства увлекаюсь походами, охотой и рыбалкой.Со мной не пропадете.", Image = "" });
            instructors.Add(new Instructor("Горбунов", "Тимофей", "Романович", "3316 564523", "+79128029498", DateTime.Parse("8/8/2020 00:00")) { ID = 4, Login = "instr4", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Мастер спорта по гребле. Байдарка для меня — смысл жизни. С самого детства в ней, со мной не пропадете.", Image = "" });
            instructors.Add(new Instructor("Новиков", "Даниил", "Михайлович", "3315 258965", "+79123687951", DateTime.Parse("5/5/2021 00:00")) { ID = 5, Login = "instr5", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Старший инструктор. Вожу в походы уже 15 лет. Знаю все маршруты вдоль и поперек.", Image = "" });
            instructors.Add(new Instructor("Журавлев", "Фёдор", "Тимурович", "3316 225485", "+79225854707", DateTime.Parse("6/5/2020 00:00")) { ID = 6, Login = "instr6", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Душа компании. Со мной не соскучитесь. Со мной можно поговорить в любое время и на любые темы.", Image = "" });
            instructors.Add(new Instructor("Лазарева", "Ангелина", "Вадимировна", "3314 552314", "+79533402030", DateTime.Parse("7/5/2021 00:00")) { ID = 7, Login = "instr7", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "А вы пробовали когда-нибудь яичницу, приготовленную на костре или аппетитные оладьи на свежем воздухе? Со мной обязательно попробуете!", Image = "" });
            instructors.Add(new Instructor("Судаков", "Марк", "Артёмович", "3315 821423", "+79129717101", DateTime.Parse("5/7/2020 00:00")) { ID = 8, Login = "instr8", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Мастер на все руки. Сколотить деревянный помост? Сделать скамейки, чтобы посидеть у костра? Это все ко мне.", Image = "" });
            instructors.Add(new Instructor("Жилин", "Евгений", "Константинович", "3316 452301", "+79539716504", DateTime.Parse("5/6/2021 00:00")) { ID = 9, Login = "instr9", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Профессиональный экскурсовод. Проведу увлекательную экскурсию на любом маршруте, расскажу про все интересные места.", Image = "" });
            instructors.Add(new Instructor("Калугина", "Анна", "Николаевна", "3317 266312", "+79122433993", DateTime.Parse("5/5/2019 00:00")) { ID = 10, Login = "instr10", Password = "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3", Discription = "Хорошо играю на гитаре. Вечером у костра со мной не заскучаете. ", Image = "" });
