...
namespace TouristСenterLibrary
{
    public static class EntityConfigure
    {
        ...
        public static void RouteConfigure(EntityTypeBuilder<Route> builder)
        {
            ...
            routes.Add(new Route("Поющие пески", 3, "Поющие пески Вятки ") { ID = 4, FullDescription = "1", Popularity = 1, CheckpointStartID = 7, CheckpointFinishID = 8, River = "Вятка", Images = new string[] { "1", "2", "3" } });
            routes.Add(new Route("Быстрая вода", 2, "Очень красивые и живописные места, на очень быстрой и стремительной реке Быстрице") { ID = 5, FullDescription = "1", Popularity = 1, CheckpointStartID = 9, CheckpointFinishID = 10, River = "Быстрица", Images = new string[] { "1", "2", "3" } });
